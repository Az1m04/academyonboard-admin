...
const { TabPane } = Tabs;
const DemoClients = ({ dispatch, leadData, loading, branchLeadStats }) => {
  const { demoTabName } = useParams();
  ...
  const getClients = (search) => {
    const query = {
      ...
      keyword: search,
      demoAccountStatus: getTabKey(),
    };
    if (demoTabName === 'all') {
      delete query.demoAccountStatus;
      query.demo = true;
    }
    dispatch({
  ...
  }, [viewSize, keyword, startIndex, actionKey, demoTabName]);
  ...
  const tabs = [
    {
      ...
      title: (
        <Badge
          count={branchLeadStats?.leadStudentStats?.allDemoAccountCount}
          size="small"
          style={{
            fontSize: '10px',
            marginTop: '3px',
    ...
    },
    {
      ...
      title: (
        <Badge
          count={branchLeadStats?.leadStudentStats?.scheduleDemoAccountCount}
          size="small"
          style={{
            fontSize: '10px',
            marginTop: '3px',
        ...
        >
          <p className="pt-2.5 pr-3 m-0">{`Scheduled`}</p>
        </Badge>
      ),
    },
    {
      ...
      title: (
        <Badge
          count={branchLeadStats?.leadStudentStats?.runningDemoAccountCount}
          size="small"
          style={{
            fontSize: '10px',
            marginTop: '3px',
        ...
        >
          <p className="pt-2.5 pr-3 m-0">{`Running`}</p>
        </Badge>
      ),
    },
    {
      ...
      title: (
        <Badge
          count={branchLeadStats?.leadStudentStats?.completedDemoAcoountCount}
          size="small"
          style={{
            fontSize: '10px',
            marginTop: '3px',
        ...
        >
          <p className="pt-2.5 pr-3 m-0">Completed</p>
        </Badge>
      ),
    },
  ];
  ...
  return (
    <div className="bg-white my-16">
      <Tabs
        defaultActiveKey={demoTabName}
        className={`w-full `}
        onChange={onTabChange}
        onTabClick={(e) => history.push(`/leads/client/branch/demo/${e?.toLowerCase()}`)}
        activeKey={demoTabName}
      >
        {tabs.map(({ key, title }) => (
