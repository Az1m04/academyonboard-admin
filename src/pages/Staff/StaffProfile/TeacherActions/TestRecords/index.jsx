...
import StaffTestReports from './StaffTestReports';
import AssignedTest from './AssignedTest';
import StaffHomeWork from './StaffHomeWork';
import StaffPraticeTest from './StaffPraticeTest';
  ...
  return (
    <div>
      <div className="flex justify-between">
        <div className="text-blue-600 font-semibold text-lg">Test Records</div>
        <div className="flex justify-between">
          <div className="mr-4">
            <Select
              style={{ width: '12rem' }}
      ...
      <Tabs defaultActiveKey="5">
        ...
        <TabPane tab={<span className="font-semibold">Assigned Test(6)</span>} key="2">
          <AssignedTest studentId={studentId} />
        </TabPane>
...
export default connect(() => ({}))(TestRecords);
