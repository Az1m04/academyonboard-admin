...
import { Avatar, Checkbox, Col, Form, Input, Popover, Row, Select } from 'antd';
    ...
    <div>
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            message: 'Please input the reason to escalate the task!',
          },
        ]}
      >
        <TextArea
          ...
          autoSize
          size="large"
          placeholder="Add reason to escalate the task!"
        />
      </Form.Item>
    </div>
  );
