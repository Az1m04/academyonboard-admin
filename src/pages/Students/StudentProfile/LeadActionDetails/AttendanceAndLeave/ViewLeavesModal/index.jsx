...
function ViewLeavesModal({ viewModal, setViewModal, studentLeave }) {
  const handleOk = () => {
    setViewModal(false);
  };
                    ...
                    <div className="px-5 text-md font-semibold ">
                      <div className="w-full mt-2">
                        ...
                        <div className="flex justify-between">
                          <div>
                            App. Number : <span className="font-bold">{studentLeave?.leaveId}</span>
                          </div>
                          <div>
                            Leave Type :{' '}
                            <span className="text-gray-500">{studentLeave?.leaveType}</span>{' '}
                          </div>
                        </div>
                        <div className="flex justify-between">
                          <div>
                            ...
                            <span className="text-gray-500">
                              {moment(studentLeave?.startsAt).format('DD MMM YYYY')}
                            </span>{' '}
                          </div>
                          <div>
                            To Date :{' '}
                            <span className="text-gray-500">
                              {moment(studentLeave?.endsAt).format('DD MMM YYYY')}
                            </span>
                          </div>
                        </div>
                        <div>
                          Reason :{' '}
                          <span className="text-gray-500">{studentLeave?.reasonForLeave}</span>
                        </div>
                        <div>
                          Remarks :{' '}
                          <span className="text-gray-500">
              ...
              <div className="border-2 border-gray-200 relative py-5 rounded-md ">
                ...
                <div className="px-5 text-md font-semibold ">
                  <div className="w-full mt-2">
                    ...
                    <div className="flex justify-between">
                      <div>
                        Status : <span className="font-bold">{studentLeave?.leaveStatus}</span>{' '}
                      </div>
                      <div>
                    ...
                    <div className="flex justify-between">
                      ...
                      <div>
                        Action Taken : <span className="text-gray-500">Areeb</span>
                      </div>
                    </div>
                    <div className="mt-2">
                      <table className="table-fixed w-full ">
                        ...
                        <tbody className="border">
                          <tr>
                            <td className="border-r-2 border-r text-center ">Areeb</td>
...
export default connect(({ student }) => ({
  ...
  studentLeave: student?.studentLeave,
}))(ViewLeavesModal);
